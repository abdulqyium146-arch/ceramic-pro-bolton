  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 h-16">
        {/* WhatsApp first — highest converting on mobile for service businesses */}
        <a
          href={`https://wa.me/${BUSINESS.whatsapp}?text=${WA_MESSAGE}`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center justify-center gap-1 bg-[#25D366] text-white hover:bg-[#20b858] transition-colors"
        ...
        <a
          ...
          className="flex flex-col items-center justify-center gap-1 text-white hover:bg-white/5 transition-colors border-x border-[#3a3a3a]"
